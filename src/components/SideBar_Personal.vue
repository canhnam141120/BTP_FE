      ...
      <div class="menu-sidebar__content js-scrollbar1">
        <nav class="navbar-sidebar">
          <ul class="list-unstyled navbar__list">
            <li class="active">
              <button><router-link to="/Personal/MyInformation">Thông tin cá nhân</router-link></button><br><br>
            </li>
            <li class="active">
              <button><router-link to="/Personal/MyBooks">Sách của tôi</router-link></button><br><br>
            </li>
            <li class="active">
              <button><router-link to="/Personal/MyPosts">Bài đăng của tôi</router-link></button>
            </li>
            <li class="active">
