        ...
        <div class="col-lg-6">
          <div class="user-data m-b-30">
            <h3 class="title-3 m-b-30">
              <i class="zmdi zmdi-account-calendar"></i>Chi tiết hoá đơn thuê</h3>
...
<!--        <div><label>Phí thuê: </label><span>{{bill.rentFee}}</span></div>-->
...
<!--        <button><router-link to="/ManageBill/rent-bill">Quay lại</router-link></button>-->
<!--      </div>-->
<!--    </div>-->
<!--  </div>-->
<!--  </SideBar>-->
...
export default {
  ...
  methods: {
    getBillById() {
      const url = API_MANAGE_BILL.DETAIL_BILL_RENT + this.$route.query.id
