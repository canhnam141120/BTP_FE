        ...
        <div class="header-mobile__bar">
          <div class="container-fluid">
            <div class="header-mobile-inner">
              <a class="logo" href="#">
                <img src="../../image/logo-tramsach.png" alt="Tramsach"/>
              </a>
        ...
        <div class="menu-sidebar__content js-scrollbar1">
          <nav class="navbar-sidebar">
            <ul class="list-unstyled navbar__list">
              ...
              <li>
                <router-link to="/managebook">Home Page</router-link>
              </li>
            ...
            <div class="container-fluid">
                ...
                <div class="col-lg-6">
                  <div class="user-data m-b-30">
                    <h3 class="title-3 m-b-30">
                      <i class="zmdi zmdi-account-calendar"></i>Book data</h3>
                    <table class="table table-data2">
                      ...
                      <tbody v-for="item of listBook" :key="item.id">
                      <tr>
                        <td>{{ item.author }}</td>
                        <td>{{ item.title }}</td>
                        <td>{{ item.description }}<br></td>
                        <td class="text-right">{{ item.publisher }}</td>
                  ...
                  <div class="user-data m-b-30">
                    ...
                    <div class="table-responsive table-data">
                      <table class="table">
                        ...
                        <tbody v-for="item of listuser" :key="item.id">
                        <tr>
                          <td>
                            <label class="au-checkbox">
                              <input type="checkbox">
                          ...
                          <td>
                              <span>
                                  <i>{{ item.addressMain }}</i>
                              </span>
                          </td>
                          <td>
                            <span class="role admin">{{ item.roleid }}</span>
                          </td>
                          <td>
                              <span>
                                  <button class="au-btn au-btn-icon au-btn--green au-btn--small">
                          <i class="zmdi zmdi-plus"></i>Ban
                        </button>
                              </span>
                          </td>
                        </tr>
              ...
              <div class="row">
                <div class="col-lg-6">
                  <div class="user-data m-b-30">
                    <h3 class="title-3 m-b-30">
                      <i class="zmdi zmdi-account-calendar"></i>List post</h3>
...
<!--                    </div>-->
                  ...
                  <div class="table-responsive table-responsive-data2">
                    <table class="table table-data2">
                      ...
                      <tbody v-for="item of listPost" :key="item.id">
                      <tr class="tr-shadow">
                        <td>
                          <label class="au-checkbox">
                            <input type="checkbox">
...
import {API_POST, API_MANAGE_USER, API_BOOK} from "@/constant/constant-api";
